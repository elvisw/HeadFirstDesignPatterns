...
namespace HomeTheater
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            var streaming = new StreamingPlayer("Open Android Box",amp);
            var projector = new Projector("Top-O-Line Projector", streaming);
            ...
            var homeTheater = new HomeTheaterFacade(amp, tuner, dvd, cd, streaming, projector, screen, lights, popper);
