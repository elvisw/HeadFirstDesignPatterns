...
namespace HomeTheater
{
    public class Amplifier
    {
        ...
        public StreamingPlayer Streaming { get; private set; }
        ...
        public void SetStreamingPlayer(StreamingPlayer streaming)
        {
            Console.WriteLine($"{_description} setting Streaming player to {streaming}");
            Streaming = streaming;
        }
